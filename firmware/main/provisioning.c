...
"<title>ImmPakt Setup</title>"
"<style>"
":root{--bg:#f1f0ec;--surface:#fff;--fg:#18181b;--muted:#71706c;"
"--accent:#1E83F7;--accent-hover:#1668c9;--accent-soft:#e7f1fe;"
...
/* Brand mark: the PicPak silhouette (body, panel, button, wordmark bar) with
 * one Immich brand colour per shape and the fifth as the outline. The inner
 * shapes are transparent moats cut through the body, so the gaps take the page
 * colour. Canonical source: res/icon/immpakt.svg. */
"<div class=\"brand\">"
"<svg class=\"brand-mark\" viewBox=\"0 0 256 256\" width=\"32\" height=\"32\" aria-hidden=\"true\">"
"<defs><mask id=\"ip-moat\">"
"<rect width=\"256\" height=\"256\" fill=\"#fff\"/>"
"<rect x=\"16.13\" y=\"16.13\" width=\"223.74\" height=\"164.86\" rx=\"20.99\"/>"
"<circle cx=\"55.04\" cy=\"216.32\" r=\"29.95\"/>"
"<rect x=\"85.25\" y=\"196.61\" width=\"154.62\" height=\"39.42\" rx=\"16.13\"/>"
"</mask></defs>"
"<rect x=\"2.56\" y=\"2.56\" width=\"250.88\" height=\"250.88\" rx=\"25.6\" "
"fill=\"#1E83F7\" stroke=\"#FFB400\" stroke-width=\"5.12\" mask=\"url(#ip-moat)\"/>"
"<rect x=\"26.88\" y=\"26.88\" width=\"202.24\" height=\"143.36\" rx=\"10.24\" fill=\"#ED79B5\"/>"
"<circle cx=\"55.04\" cy=\"216.32\" r=\"19.2\" fill=\"#FA2921\"/>"
"<rect x=\"96\" y=\"207.36\" width=\"133.12\" height=\"17.92\" rx=\"5.38\" fill=\"#18C249\"/>"
"</svg>"
"<span>ImmPakt</span></div>"
...
"<section class=\"card\" style=\"display:none\"><h2>Transport</h2>"
"<div class=\"field\">"
...
"<p class=\"hint\" style=\"margin:2px 0 0\">"
"Polls the photo server directly. No broker needed.</p>"
"</span>"
"</label>"
"</div>"
"</section>";
...
"<section class=\"card rest-only\"><h2>Photo server</h2>"
"<div class=\"field\">"
"<label for=\"server_url\">Server URL</label>"
"<input id=\"server_url\" name=\"server_url\" maxlength=\"159\" "
"autocomplete=\"off\" value=\"%s\" placeholder=\"http://192.168.1.10:8080\">"
"<p class=\"hint\">Where your <strong>ImmPakt</strong> server is reachable "
"from this network &mdash; hostname or LAN IP "
"(e.g. <code>http://192.168.1.10:8080</code>). "
"<code>https://</code> needs a publicly-trusted certificate; "
"self-signed won&rsquo;t work.</p>"
"</div>"
"<div class=\"field\">"
"<label for=\"pairing_code\">Device key <span style=\"color:var(--muted);font-weight:400\">(optional)</span></label>"
"<input id=\"pairing_code\" name=\"pairing_code\" maxlength=\"32\" "
"autocomplete=\"off\" value=\"%s\">"
"<p class=\"hint\">Leave blank unless you set <code>server.device_key</code> "
"in the server config. Devices self-register otherwise.</p>"
"</div>"
"</section>"
...
"<div class=\"credits\">"
"Server &middot; <span>ImmPakt</span><br>"
"Firmware &middot; derived from <span>varanu5/picpak-tesserae-client</span>"
"</div>"
"</main></body></html>";
...
"h1{margin:0 0 8px;font-size:20px;color:#1E83F7}"
"p{margin:0;color:#71706c;font-size:14px;line-height:1.5}"
"</style></head><body>"
"<div class=\"card\"><h1>Saved</h1>"
"<p>The frame will reboot and apply the new settings now.</p></div>"
"</body></html>";
